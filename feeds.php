...
<div class="title" style="margin:15px; margin-bottom: 50px;"><i class="fa fa-rss" aria-hidden="true"></i> <?=RSS_FEEDS_MANAGER;?></div>

<div class="content-feeds">
<p style="text-align: center; margin-bottom: 40px;"><?=YOU_SUBSCRIBED;?> <strong><?=$totalfeeds;?></strong> <?=FEEDS;?>.</p>
<?php 
...
$thumbnail = str_replace("/var/www/my_webapp/www/storage/icons/", "storage/icons/", $thumbnail);
...
<p><a href="<?=WEBSITE_URL."/feed/".$feed_id;?>" style="color:var(--feedbot-title); vertical-align: middle; font-weight: bold; padding-top: 4px; text-decoration: none;"> <?=$title;?></span></p>
...
<p style="margin-top: 10px;">
    <?php if ($is_active == '1') { ?>
        <form class="switch autoshare_on_<?=$sub_id;?>" style="display: none;">
            ...
            <button onclick="autoshare_on(<?=$sub_id;?>)" class="switch" title="<?=PUBLISH_ON_MASTODON;?>" /><span class="fa-stack fa-lg"><i class="fa fa-toggle-off fa-2x" aria-hidden="true" style="color:var(--feedbot-text);"></i></span></button>
        </form>

        <form class="switch autoshare_off_<?=$sub_id;?>">
            <input type="hidden" name="action" value="desactivate_feed">
            <input type="hidden" name="sub_id" value="<?=$sub_id;?>">
            <button onclick="autoshare_off(<?=$sub_id;?>)" class="switch" title="<?=STOP_PUBLISH_ON_MASTODON;?>" /><span class="fa-stack fa-lg"><i class="fa fa-toggle-on fa-2x" aria-hidden="true"></i></span></button>
        </form>
    <?php } else { ?>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="sharetitle_off(<?=$sub_id;?>)" class="switch" title="<?=STOP_PUBLISH_TITLE;?>" /><span class="fa-stack fa-lg"><i class="fa fa-toggle-on fa-2x" aria-hidden="true"></i></span></button>
</form>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="sharetitle_on(<?=$sub_id;?>)" class="switch" title="<?=PUBLISH_TITLE;?>" /> <span class="fa-stack fa-lg"><i class="fa fa-toggle-off fa-2x" aria-hidden="true" style="color:var(--feedbot-text);"></i></span></button>
</form>
<?php } else { ?>
...
<?php } ?> <span style="vertical-align: middle; padding-top: 2px; margin-left: 10px;"><?=PUBLISH_TITLE;?></span></p>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="sharedescription_off(<?=$sub_id;?>)" class="switch" title="<?=STOP_PUBLISH_DESCRIPTION;?>" /><span class="fa-stack fa-lg"><i class="fa fa-toggle-on fa-2x" aria-hidden="true"></i></span></button>
</form>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="sharedescription_on(<?=$sub_id;?>)" class="switch" title="<?=PUBLISH_DESCRIPTION;?>" /><span class="fa-stack fa-lg"><i class="fa fa-toggle-off fa-2x" aria-hidden="true" style="color:var(--feedbot-text);"></i></span></button>
</form>
<?php } else { ?>
...
<?php } ?> <span style="vertical-align: middle; padding-top: 2px; margin-left: 10px;"><?=PUBLISH_DESCRIPTION;?></span></p>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="shareimage_off(<?=$sub_id;?>)" class="switch" title="<?=STOP_ATTACH_IMAGE;?>" /><span class="fa-stack fa-lg"><i class="fa fa-toggle-on fa-2x" aria-hidden="true"></i></span></button>
</form>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="shareimage_on(<?=$sub_id;?>)" class="switch" title="<?=ATTACH_IMAGE;?>" /> <span class="fa-stack fa-lg"><i class="fa fa-toggle-off fa-2x" aria-hidden="true" style="color:var(--feedbot-text);"></i></span></button>
</form>
<?php } else { ?>
...
<?php } ?> <span style="vertical-align: middle; padding-top: 2px; margin-left: 10px;"><?=ATTACH_IMAGE;?></span></p>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="is_sensitive_off(<?=$sub_id;?>)" class="switch" title="<?=DESACTIVATE_SENSITIVE_CONTENT;?>" /><span class="fa-stack fa-lg"><i class="fa fa-toggle-on fa-2x" aria-hidden="true"></i></span></button>
</form>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="is_sensitive_on(<?=$sub_id;?>)" class="switch" title="<?=ACTIVATE_SENSITIVE_CONTENT;?>" /> <span class="fa-stack fa-lg"><i class="fa fa-toggle-off fa-2x" aria-hidden="true" style="color:var(--feedbot-text);"></i></span></button></form>

<span style="vertical-align: middle; padding-top: 2px; margin-left: 10px;"><?=SENSITIVE_CONTENT;?></span></p>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="sensitive_text(<?=$sub_id;?>)" class="sensitive_button_on_<?=$sub_id;?>" style="padding-left:16px; padding-right:14px; margin-top: -37px; height:36px; line-height:10px; vertical-align:middle;"><span style="vertical-align: middle;">Ok</span></button>
<button class="sensitive_button_off_<?=$sub_id;?>" style="padding-left:16px; padding-right:14px; margin-top: -37px; height:36px; line-height:10px; vertical-align:middle; display: none;" disabled><span style="vertical-align: middle;"><i class="fa fa-check" aria-hidden="true"></i></span></button>
...
<button type="submit" class="switch"><span class="fa-stack fa-lg"><i class="fa fa-toggle-off fa-2x" aria-hidden="true" style="color:var(--feedbot-text);"></i></span></button>
</form>
...
<button onclick="telegram_off(<?=$sub_id;?>)" class="switch" title="<?=STOP_TELEGRAM;?>" /><span class="fa-stack fa-lg"><i class="fa fa-toggle-on fa-2x" aria-hidden="true"></i></span></button>
</form>
...
<span class="fa-stack fa-lg"><i class="fa fa-toggle-off fa-2x" aria-hidden="true" style="color:var(--feedbot-text);"></i></span></button>
</form>
<?php } else { ?>
...
<button onclick="telegram_on(<?=$sub_id;?>)" class="switch" title="<?=TELEGRAM;?>" />
<span class="fa-stack fa-lg"><i class="fa fa-toggle-off fa-2x" aria-hidden="true" style="color:var(--feedbot-text);"></i></span></button>
</form><?php } ?> <span style="vertical-align: middle; padding-top: 2px; margin-left: 10px;"><?=TELEGRAM;?></span></p>
...
<input type="hidden" name="sub_id" value="<?=$sub_id;?>">
<button onclick="if(!confirm('<?=DELETE_FEED_CONFIRM;?>')){return false;}; unsubscribe(<?=$sub_id;?>); hideelement(<?=$sub_id;?>);" class="switch" title="<?=DELETE_FEED;?>"/><span class="fa-stack fa-lg" style="line-height: 34px; width: 34px; font-size: 16px;"><i class="fa fa-times-circle fa-2x" aria-hidden="true" style="color:var(--feedbot-text);"></i></span></button>
</form>
<span class="unsubscribe_<?=$sub_id;?>" style="vertical-align: middle; margin-left: 16px; padding-top: 2px;"><?=DELETE_FEED;?></span></p>
