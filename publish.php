...
<div class="title"><i class="fa fa-paper-plane" aria-hidden="true"></i> <?=PUBLISH_PAGE_TITLE;?></div>
<div class="content-publish">
        ...
        <button type="submit"><span><i class="fa fa-mastodon fa-2x" aria-hidden="true" style="vertical-align: middle;"></i></span> <span style="vertical-align: middle; margin-left: 10px;"><?=SHARE;?></span></button>
        </form>

        <?php if ($article_id == "") { ?><p style="font-style: italic; font-size: 12px; margin-top: 22px; text-align: center;"><?=NO_DATA;?>.</p><?php } ?>
</div>