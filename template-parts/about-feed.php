...
<h4 style="color:var(--feedbot-title);"><i class="fa fa-info-circle" aria-hidden="true" style="margin-right:6px;"></i> <?=ABOUT;?></h4>
...
<?php if ($caracters_counter > "400") { ?><div id="read-more-about" style="width:100%; font-weight:bold; text-align:center; margin-top:10px; cursor:pointer;"><?= READ_MORE ?></div><?php } ?>
