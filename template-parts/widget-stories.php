<?php
$time = time() - (60 * 60 * 24);
$sql = "SELECT DISTINCT feed_id, MAX(date) FROM articles WHERE date > '$time' GROUP BY feed_id ORDER BY MAX(date) DESC, feed_id";
...
<div style="position: relative; display: inline-block;">
    <div style="float:left; width:90px; text-align: center; overflow: hidden; text-overflow: ellipsis;">
        ...
        <div class="story-avatar" style="background-image: url(<?php echo $feed_avatar; ?>);"></div>
        </div>
