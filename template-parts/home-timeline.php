...
<div class="content-home" style="padding-top: 15px; padding-bottom: 0px;" id="<?=$date;?>">
    <div style="height:75px;">
        ...
        <form class="follow-button subscribe_<?=$feed_id;?>" style="display:none;" title="<?= SUBSCRIBE_TO ?> <?=$feed_name;?>">
