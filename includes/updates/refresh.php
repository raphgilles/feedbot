...
<div class="timeline-thumbnail" style="width: 600px; margin:auto; margin-bottom: 10px; border-radius: 12px; border: 1px solid var(--feedbot-thumbnails-borders); cursor: initial; overflow: hidden; text-overflow: ellipsis;">
    ...
    <div class="timeline-title" style="width: 100%; margin-left: 15px; margin-right: 15px; padding-bottom: 4px; text-align: left;"><span style="font-weight:bold;"><?=$title;?></span></div>
    <?php if ($description !== "") { ?>
    <div style="width:100%; margin-bottom: 15px; text-align: left; margin-left: 15px; padding-right: 27px; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical;"><span><?=truncate($description,200);?></span></div>
    <?php } ?>
</div>
