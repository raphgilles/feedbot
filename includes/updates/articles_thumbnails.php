...
while($row2 = $result2->fetch_array()){
    ...
    $media_thumb = "/var/www/my_webapp/www/storage/thumbnails/".sha1(time()).".jpg";
    ...
    echo $title." - ".$url."<br />";
    $thumbpath = str_replace("/var/www/my_webapp/www/storage/thumbnails/", WEBSITE_URL."/storage/thumbnails/", $thumbnail);
